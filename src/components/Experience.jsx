  ...
  return (
    <section id="experience" ref={ref} style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(232,147,90,0.03) 0%, transparent 70%)',
            ...
            {experiences.map((exp, i) => (
              <button
                ...
                style={{
                  ...
                  textAlign: 'left',
                  background: active === i ? 'var(--surface)' : 'none',
                  border: 'none',
                  borderLeft: `2px solid ${active === i ? 'var(--emerald)' : 'transparent'}`,
                  cursor: 'pointer',
                  transition: 'all 0.25s',
                  marginLeft: '-1px',
                  borderRadius: '0 6px 6px 0',
                }}
                onMouseEnter={e => { if (active !== i) e.currentTarget.style.background = 'rgba(45,212,160,0.04)'; }}
              ...
              >
                <div style={{
                  ...
                  fontSize: '0.9rem',
                  color: active === i ? 'var(--emerald)' : 'var(--fog)',
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '1.5rem', marginBottom: '1.75rem', flexWrap: 'wrap' }}>
              <span style={{
                ...
                fontFamily: 'var(--font-mono)', fontSize: '0.73rem', color: 'var(--mist)',
              }}>
                <Calendar size={12} />
